...
document.addEventListener("DOMContentLoaded", () => {
  ...
  toggleBtn.addEventListener("click", () => {
    logsContent.classList.toggle("logs-hidden");
  ...
  const mockDisasterData = {
    ...
    classifications: [
      { labels: ['Urban', 'Forest', 'Water', 'Agriculture', 'Other'], data: [40, 20, 15, 15, 10] }, // Urban area
      { labels: ['Urban', 'Forest', 'Water', 'Agriculture', 'Other'], data: [10, 50, 20, 15, 5] }  // Rural area
    ],
  ...
  document.getElementById('exportTrend').addEventListener('click', () => exportChart('trendChart', 'trends.png'));
  document.getElementById('exportBar').addEventListener('click', () => exportChart('disasterBarChart', 'disasters.png'));
});